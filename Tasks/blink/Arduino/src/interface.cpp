...
void processSerialData() {
    if (newData == true) {
        ...
        if (strcmp(varname,"LED_ON_dur")==0){
            log_ulong("LED_ON_dur", LED_ON_dur);
        }

        if (strcmp(varname,"LED_OFF_dur")==0){
            log_ulong("LED_OFF_dur", LED_OFF_dur);
        }
        ...
        if (strcmp(varname,"LED_ON_dur")==0){
            LED_ON_dur = strtoul(varvalue,NULL,10);
        }

        if (strcmp(varname,"LED_OFF_dur")==0){
            LED_OFF_dur = strtoul(varvalue,NULL,10);
        }
