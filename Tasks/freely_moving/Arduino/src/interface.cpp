...
void processSerialData() {
    if (newData == true) {
        ...
        if (strcmp(varname,"rew_avail_dur")==0){
            log_ulong("rew_avail_dur", rew_avail_dur);
        }

        if (strcmp(varname,"n_trials")==0){
            log_ulong("n_trials", n_trials);
        }
        ...
        if (strcmp(varname,"rew_avail_dur")==0){
            rew_avail_dur = strtoul(varvalue,NULL,10);
        }

        if (strcmp(varname,"n_trials")==0){
            n_trials = strtoul(varvalue,NULL,10);
        }
