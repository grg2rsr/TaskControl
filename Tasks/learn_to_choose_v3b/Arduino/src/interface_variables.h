...
unsigned long buzz_dur = 2000;
unsigned long kamin_block_protect_dur_min = 500;
unsigned long kamin_block_protect_dur_max = 1500;
unsigned long trial_entry_buzz_dur = 5;
unsigned long buzz_center_freq = 235;
unsigned long buzz_high_freq = 270;
unsigned long buzz_low_freq = 200;
int led_hsv = 180;
