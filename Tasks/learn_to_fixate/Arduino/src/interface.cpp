...
void processSerialData() {
    if (newData == true) {
        ...
        if (strcmp(mode,"GET")==0){
            ...
            if (strcmp(varname,"interval_gap_start")==0){
                Serial.println(String("<VAR ")+String(varname)+String("=")+String(interval_gap_start)+String(">"));
            }
    
            if (strcmp(varname,"interval_gap_target")==0){
                Serial.println(String("<VAR ")+String(varname)+String("=")+String(interval_gap_target)+String(">"));
            }
    
            if (strcmp(varname,"interval_gap_incr")==0){
                Serial.println(String("<VAR ")+String(varname)+String("=")+String(interval_gap_incr)+String(">"));
            }
    
            if (strcmp(varname,"interval_gap_decr")==0){
                Serial.println(String("<VAR ")+String(varname)+String("=")+String(interval_gap_decr)+String(">"));
            }
        ...
        if (strcmp(mode,"SET")==0){
            ...
            if (strcmp(varname,"interval_gap_start")==0){
                interval_gap_start = strtoul(varvalue,NULL,10);
            }
    
            if (strcmp(varname,"interval_gap_target")==0){
                interval_gap_target = strtoul(varvalue,NULL,10);
            }
            ...
            if (strcmp(varname,"interval_gap_incr")==0){
                interval_gap_incr = atof(varvalue);
            }
    
            if (strcmp(varname,"interval_gap_decr")==0){
                interval_gap_decr = atof(varvalue);
            }
