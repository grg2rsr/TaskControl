...
// unsigned long buzz_left = 165;
// unsigned long buzz_right = 305;
// unsigned long buzz_lat = 235;
unsigned long buzz_center_freq = 235;
unsigned long buzz_freq_sep = 70;
int led_hsv = 180;
...
unsigned long min_grasp_dur = 100;
int trial_autostart = 0;
float p_timing_trial = 0.05;
