...
const unsigned int FIXATE_STATE = 3;
...
unsigned int FIXATION_BROKEN_EVENT = 46;
unsigned int FIXATION_SUCCESSFUL_EVENT = 47;
...
unsigned int FIXATE_ON = 55;
unsigned int FIXATE_OFF = 56;
