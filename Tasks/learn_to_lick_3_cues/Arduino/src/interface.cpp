...
void processSerialData() {
    if (newData == true) {
        ...
        if (strcmp(mode,"GET")==0){
            ...
            if (strcmp(varname,"punish_cue_freq")==0){
                Serial.println(String("<")+String(varname)+String("=")+String(punish_cue_freq)+String(">"));
            }
            ...
            if (strcmp(varname,"reward_prob")==0){
                Serial.println(String("<")+String(varname)+String("=")+String(reward_prob)+String(">"));
            }
