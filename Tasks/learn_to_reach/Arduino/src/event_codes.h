...
const unsigned int PRESENT_CUE_STATE = 3;
const unsigned int CHOICE_STATE = 4;
const unsigned int REWARD_LEFT_AVAILABLE_STATE = 5;
const unsigned int REWARD_RIGHT_AVAILABLE_STATE = 6;
const unsigned int ITI_STATE = 7;
...
// reward related
unsigned int REWARD_LEFT_AVAILABLE_EVENT = 30;
unsigned int REWARD_LEFT_COLLECTED_EVENT = 31;
