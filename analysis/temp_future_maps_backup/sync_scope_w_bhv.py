...
animals_folder = Path(
    "/media/georg/htcondor/shared-paton/georg/Animals_smelling_imaging"
)
...
def sync_bhv_and_mic(session_folder):
    ...
    frame_timestamps = bhv.correct_wraparound_np(
        np.array(frame_timestamps), max_val=2**32
    )
    trial_timestamps = bhv.correct_wraparound_np(
        np.array(trial_timestamps), max_val=2**32
    )
...
folders.append(
    Path(
        "/media/georg/htcondor/shared-paton/georg/Animals_smelling_imaging_sessions_2/JJP-05472/2023-03-08_JJP-05472_8"
    )
)
folders.append(
    Path(
        "/media/georg/htcondor/shared-paton/georg/Animals_smelling_imaging_sessions_2/JJP-05472/2023-03-09_JJP-05472_9"
    )
)
folders.append(
    Path(
        "/media/georg/htcondor/shared-paton/georg/Animals_smelling_imaging_sessions_2/JJP-05472/2023-03-10_JJP-05472_10"
    )
)
